...
The todays unbounded growth of information digitally available suggests a massive and chaotic collection of data. An in 2014 published report by ICD states that the digitalized data grow by 100\% every two years and will reach 44 zettabytes (10\textsuperscript{21} bytes) by 2020 - as many stars as known in the universe. 
% ref
\\\\
...
% ref Challenges and opportunities with big data
...
% ref Applications of geometric algebra in computer science and engineering (91 - 96)
, database normalization
% ref Information Modeling and Relational Databases (743)
or schema definitions
% ref Information Modeling and Relational Databases (62)
...
% ref RDBMS dominate the database market, but NoSQL systems are catching up
...
% ref  Issues in Handling Complex Data Structures with NoSQL Databases
...
% ref Beyond Accuracy: What Data Quality Means to Data Consumers
...
% ref The Impact of Website Quality on Information Quality, Value, and Loyalty Intentions in Apparel Retailing
...
% rf	The Assessment of Software Quality from the User Perspective
...
% Data Quality - Exploratory Data Mining and Data Cleaning
